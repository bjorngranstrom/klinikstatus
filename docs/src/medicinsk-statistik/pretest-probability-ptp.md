...
next: {
    ...
    link: 'medicinsk-statistik/likelyhood-ratio-lr'
}
---
...
Hur ska vi då göra för att enkelt kalkylera hur PTP förändras efter en undersökning är gjord? [<gr> Låt mig förklara. </gr>](./likelyhood-ratio-lr)
